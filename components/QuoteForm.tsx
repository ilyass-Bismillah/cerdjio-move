  ...
  if (submitted) {
    return (
      <motion.div
        ...
        className="p-12 rounded-3xl border border-green-500/30 bg-gray-900/60 backdrop-blur-xl text-center space-y-4"
      >
        ...
        <p className="text-gray-400">
          On va vous contacter sur{" "}
          <span className="text-green-500">{formData.phone}</span> d&apos;ici 2
          heures.
        </p>
        <Button
          onClick={() => setSubmitted(false)}
          variant="outline"
          className="mt-4 px-8 py-4 font-bold"
        >
          Refaire une demande
        </Button>
      </motion.div>
