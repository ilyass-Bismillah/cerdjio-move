      ...
      <section className="relative pt-32 pb-24 px-6 border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 text-xs font-black uppercase tracking-[0.3em] mb-8"
          >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          {[
            ...
            },
            {
              ...
              icon: <Ship className="text-orange-500" />,
            ...
            <motion.div
              key={i}
              whileHover={{ y: -10 }}
              className="p-10 rounded-[3rem] bg-white/5 border border-white/10 hover:border-orange-500/50 transition-all flex flex-col items-start"
            >
              <div className="mb-6 p-4 bg-gray-900 rounded-2xl border border-white/5 text-orange-500">
                {item.icon}
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="text-4xl font-black uppercase italic">
                Réseau & <br />{" "}
                <span className="text-orange-500">Lignes Directes</span>
              </h2>
            </div>
            ...
            {routes.map((route, i) => (
              ...
              >
                ...
                <div className="flex gap-8 items-center justify-between">
                  ...
                  <div className="px-4 py-2 rounded-lg bg-orange-600/10 border border-orange-500/20 text-orange-500 text-[10px] font-black uppercase tracking-widest">
                    {route.type}
                  </div>
                </div>
              </div>
      ...
      <section className="py-32 px-6 text-center">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-black uppercase mb-8 italic">
            L&apos;expertise sans{" "}
            <span className="text-orange-500">frontières</span>
          </h2>
