    ...
    <div className="bg-[#0a0a0a] min-h-screen text-white overflow-hidden">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[3rem] p-8 backdrop-blur-md relative overflow-hidden">
              ...
              <div className="space-y-6">
                {destinations.map((d, i) => (
                  <div
                    key={i}
                    className="group flex items-center justify-between p-4 bg-black/40 rounded-2xl border border-white/5 hover:border-orange-500/40 transition-all"
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-orange-500/10 flex items-center justify-center text-orange-500 font-bold group-hover:bg-orange-500 group-hover:text-black transition-colors">
                        {i + 1}
                      </div>
                      <div>
      ...
      <section className="py-24 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="p-10 rounded-[2.5rem] bg-linear-to-br from-white/5 to-transparent border border-white/10 group hover:border-orange-500/30 transition-all">
            <Sun
      ...
      <section className="pb-20 px-6">
        <div className="max-w-7xl mx-auto bg-orange-600 rounded-[3rem] p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
