      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white mb-6">
            ...
            <span className="text-orange-500">EN EUROPE</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              <div>
                <h4 className="text-orange-500 text-4xl font-black">100%</h4>
                <p className="text-sm uppercase tracking-wider text-gray-500">
                  Zone Europe
                </p>
              </div>
              <div>
                <h4 className="text-orange-500 text-4xl font-black">24/7</h4>
                <p className="text-sm uppercase tracking-wider text-gray-500">
                  Suivi Transport
                </p>
              </div>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-orange-600/20 rounded-3xl blur-2xl"></div>
